...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString, int? page)
        {
			...
			var pageNumber = page ?? 1; // Trang hiện tại, mặc định là trang 1
            ...
            return View(await students.AsNoTracking().ToPagedListAsync(pageNumber, pageSize));
		}
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            //  đối số trong if dùng để gán dlieu mới sang dlieu cũ
